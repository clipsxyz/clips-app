    ...
    return (
        <View style={styles.row}>
            ...
            <TouchableOpacity onPress={onComment} style={styles.item} disabled={!onComment} activeOpacity={0.7}>
                <FeedMessageSquareIcon size={24} color={iconColor} />
                    ...
                    {userReclipped ? (
                        ...
                        >
                            <View style={styles.reclipInner}>
                                <FeedRepeatIcon size={14} color="#FFFFFF" />
                            </View>
                        </LinearGradient>
                    ) : (
                        <FeedRepeatIcon size={24} color={reclipIdleColor} />
                    )}
            ...
            {showSave ? (
                <TouchableOpacity onPress={onSave} style={styles.item} disabled={!onSave} activeOpacity={0.7}>
                    <FeedBookmarkIcon size={24} color={saveColor} filled={isSaved} />
